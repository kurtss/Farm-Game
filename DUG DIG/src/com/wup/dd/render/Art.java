...
public class Art {
	...
	public static BufferedImage[] POOKA;
	
	public static void loadAll(){
		FONT = cut("/res/font.png", 8, 8);
		PLAYER = cut("/res/digger.png", 16, 16);
		POOKA = cut("/res/pooka.png", 16, 16);
	}
